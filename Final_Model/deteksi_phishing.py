...
#Model Prediksi
model_path = r'C:\Users\USER\Phishing-Detection\Final_Model\DOFA-XGBoost_model.json'
#List URL Short
list_short = pd.read_csv(r'C:\Users\USER\Phishing-Detection\Final_Model\short_link_list.csv')
#List Top Level Domain
list_TLD = pd.read_csv(r'C:\Users\USER\Phishing-Detection\Final_Model\tlds.csv')
